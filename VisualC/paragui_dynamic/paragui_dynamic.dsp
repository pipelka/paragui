...
# ADD LINK32 advapi32.lib sdl.lib libfreetype.lib sdl_image.lib physfs.lib /nologo /dll /machine:I386 /out:"../../bin/paragui.dll" /implib:"../../lib/paragui.lib" /libpath:"../../lib" /libpath:"../../src/physfs/Release"
...
# ADD LINK32 advapi32.lib sdl.lib libfreetype.lib sdl_image.lib physfs.lib /nologo /dll /debug /machine:I386 /out:"../../bin/paraguid.dll" /implib:"../../lib/paraguid.lib" /pdbtype:sept /libpath:"../../lib" /libpath:"../../src/physfs/Debug"
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=Copying PhysFS DLL ...
