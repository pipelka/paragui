/*
    ...
    Update Date:      $Date: 2009/06/04 10:25:13 $
...
inline void StretchTemplate8to16(int x1, int x2, int y1, int y2, int yr, int yw, Uint8* src_pixels, Uint16* dst_pixels, Uint32* lut) {
	int dx, dy, e, d, dx2;
...
inline void RectStretch8to16(SDL_Surface* src_surface, Uint8* src, int xs1, int ys1, int xs2, int ys2, SDL_Surface* dst_surface, Uint16* dst, int xd1, int yd1, int xd2, int yd2, Uint32* lutVOI) {
	int dx, dy, e, d, dx2;
	int sx, sy;
	dx = abs((int)(yd2 - yd1));
	dy = abs((int)(ys2 - ys1));
	...
	for (d = 0; (d <= dx) && (yd1 < dst_surface->h) && (ys1 < src_surface->h); d++) {
		StretchTemplate8to16(xd1, xd2, xs1, xs2, ys1, yd1, (Uint8*)src_pixels, (Uint16*)dst_pixels, lut);
...
inline void RectStretch24to16(SDL_Surface* src_surface, Uint8* src, int xs1, int ys1, int xs2, int ys2, SDL_Surface* dst_surface, Uint16* dst, int xd1, int yd1, int xd2, int yd2, Uint32* lutVOI) {
	int dx, dy, e, d, dx2;
	int sx, sy;
	dx = abs((int)(yd2 - yd1));
	dy = abs((int)(ys2 - ys1));
	...
	for (d = 0; (d <= dx) && (yd1 < dst_surface->h) && (ys1 < src_surface->h); d++) {
		StretchTemplate24to16(xd1, xd2, xs1, xs2, ys1, yd1, (Uint8*)src_pixels, (Uint16*)dst_pixels, lut);
...
void PG_Draw::RectStretch(SDL_Surface* src_surface, int xs1, int ys1, int xs2, int ys2, SDL_Surface* dst_surface, int xd1, int yd1, int xd2, int yd2, Uint32* lutVOI) {
	...
	switch (dst_bpp) {
		...
		case 2:
			switch (src_bpp) {
				case 1:
					RectStretch8to16(src_surface, (Uint8*)src_surface->pixels, xs1, ys1, xs2, ys2, dst_surface, (Uint16*)dst_surface->pixels, xd1, yd1, xd2, yd2, lutVOI);
					break;				
				case 2:
